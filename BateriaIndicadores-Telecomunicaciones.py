...
def PlotlyConcentracion(df):    
    ...
    gridcolor='rgba(220, 220, 220, 0.4)',
    showticklabels=True)    
    fig.update_traces(marker_color='rgb(43,59,224)', marker_line_color='rgb(0,0,0)',
...
def PlotlyIHH(df):    
    ...
    'xanchor': 'center',
    'yanchor': 'top'})    
    fig.update_traces(marker_color='rgb(255,14,107)', marker_line_color='rgb(204,0,0)',
...
def PlotlyDominancia(df):    
    ...
    'xanchor': 'center',
    'yanchor': 'top'}) 
    fig.update_traces(marker_color='rgb(43,59,244)', marker_line_color='rgb(0,0,0)',
                      marker_line_width=1.5, opacity=0.4)
    return fig    
...
def PlotlyPenetracion(df):
    ...
    'xanchor': 'center',
    'yanchor': 'top'}) 
    fig.update_traces(marker_color='rgb(255,14,107)', marker_line_color='rgb(0,0,0)',
                      marker_line_width=1.5, opacity=0.4)
    return fig    
